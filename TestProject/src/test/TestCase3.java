...
/* This program creates a sample html file and updates the data on it
 * 
 */
public class TestCase3 {
	...
	public static void main(String[] args) throws IOException {
		...
		File f = new File(System.getProperty("user.dir") + "\\src\\dataFiles\\index_" + dtf.format(now) + ".html");
...
//		"which contains the details of how to create a txt file in java";
		...
		bw.write("<html><body> <title> This is a new page</title> <h1>This is a test page</h1> </body></html>");
//		bw.write(name);
//		bw.write(" ");
//		bw.newLine();
//		bw.write(paragraph);
