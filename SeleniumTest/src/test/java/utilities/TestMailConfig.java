...
public class TestMailConfig{
	...
	//Using the free smtp server - sendinblue to send the smtp mail
	public static String server="smtp-relay.sendinblue.com";
	public static String from = "XXXXX@gmail.com";
	public static String password = "abcdefkjkshds!!";
	public static String[] to ={"xxxyayere@gmail.com","invalidemail@gmail.com"};
